...
thumb_url: 'http://europepmc.org/articles/PMC3345922/bin/ZooKeys-189-001-g256.gif'
figure_no: 256
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC3345922/bin/ZooKeys-189-001-g256.jpg' style='max-height: 300px'>
### Figure 256
<p style='font-size: 10px;'>*<named-content content-type="taxon-name">Cyrnellus fraternus</named-content>* **A** total specimens collected and all known collecting localities (<xref ref-type="fig" rid="F4">Figure 4</xref>) **B** monthly adult abundance (1980s to present) **C** habitat preference (1980s to present) (<xref ref-type="table" rid="T1">Table 1</xref>) **D** male genital capsule **E** male inferior appendages (ventral view).</p>