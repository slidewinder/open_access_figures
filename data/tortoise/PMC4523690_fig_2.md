...
thumb_url: 'http://europepmc.org/articles/PMC4523690/bin/gr2.gif'
figure_no: 2
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC4523690/bin/gr2.jpg' style='max-height: 300px'>
### Figure 2
<p style='font-size: 10px;'>(a) Relationship between age in months and the mean proportion of dogs that first looked to the door within 2&nbsp;s in the test and control conditions (with 95% confidence intervals; dotted lines). (b) The mean proportion of dogs in each age group that first looked to the door within 2&nbsp;s in the test and control conditions (error bars represent SEs).</p>