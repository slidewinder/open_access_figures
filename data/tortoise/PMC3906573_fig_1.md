...
thumb_url: 'http://europepmc.org/articles/PMC3906573/bin/fninf-08-00004-g0001.gif'
figure_no: 1
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC3906573/bin/fninf-08-00004-g0001.jpg' style='max-height: 300px'>
### Figure 1
<p style='font-size: 10px;'>**Examples of intensity artifacts detected with DTIPrep**. **(A)** An electromagnetic interference-like artifact, **(B)** severe signal loss in the anterior and middle regions, **(C)** venetian blind artifact, **(D)** inter-slice and intra-slice intensity artifact, and **(E)** checkerboard artifact.</p>