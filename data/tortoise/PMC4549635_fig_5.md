...
thumb_url: 'http://europepmc.org/articles/PMC4549635/bin/fnhum-09-00444-g0005.gif'
figure_no: 5
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC4549635/bin/fnhum-09-00444-g0005.jpg' style='max-height: 300px'>
### Figure 5
<p style='font-size: 10px;'>**A reproduction of Figure 3 from Todd et al. (<xref rid="B189" ref-type="bibr">2002</xref>) illustrating the principal elements of a computational algorithm which implements the neurobiological theory**. The system is represented operating in open-loop mode, i.e., without feedback.</p>