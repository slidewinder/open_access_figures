...
thumb_url: 'http://europepmc.org/articles/PMC3345922/bin/ZooKeys-189-001-g221.gif'
figure_no: 221
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC3345922/bin/ZooKeys-189-001-g221.jpg' style='max-height: 300px'>
### Figure 221
<p style='font-size: 10px;'>*<named-content content-type="taxon-name">Pseudostenophylax sparsus</named-content>* **A** total specimens collected and all known collecting localities (<xref ref-type="fig" rid="F4">Figure 4</xref>) **B** monthly adult abundance (1980s to present) **C** habitat preference (1980s to present) (<xref ref-type="table" rid="T1">Table 1</xref>) **D** male genital capsule **E** phallus (dorsal view, reduced 50%).</p>