...
thumb_url: 'http://europepmc.org/articles/PMC3282304/bin/fpsyg-03-00039-g008.gif'
figure_no: 8
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC3282304/bin/fpsyg-03-00039-g008.jpg' style='max-height: 300px'>
### Figure 8
<p style='font-size: 10px;'>**Results of Experiment 2**. Mean gaze durations (ms) for monosyllabic and disyllabic items on repetitions 3 through 20 in the Moderate Pace Group **(A)** and the Fast Pace Group **(B)**.</p>