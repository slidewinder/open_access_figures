...
thumb_url: 'http://europepmc.org/articles/PMC4278820/bin/ece30004-4678-f6.gif'
figure_no: 6
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC4278820/bin/ece30004-4678-f6.jpg' style='max-height: 300px'>
### Figure 6
<p style='font-size: 10px;'>Body size of *Lecane inermis* at two temperatures in a laboratory experiment. GLM with temperature (fixed) and food type (random) as predictors (means ± 95% CI). Numbers given are the sample sizes.</p>