...
thumb_url: 'http://europepmc.org/articles/PMC4278820/bin/ece30004-4678-f7.gif'
figure_no: 7
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC4278820/bin/ece30004-4678-f7.jpg' style='max-height: 300px'>
### Figure 7
<p style='font-size: 10px;'>The seasonal variation of the body size of two rotifer species from activated sludge: *Lecane inermis* (A) and *Cephalodella gracilis* (B); means ± SE. Numbers given are the sample sizes analyzed per sampling.</p>