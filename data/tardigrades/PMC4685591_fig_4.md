...
thumb_url: 'http://europepmc.org/articles/PMC4685591/bin/rstb20150287-g4.gif'
figure_no: 4
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC4685591/bin/rstb20150287-g4.jpg' style='max-height: 300px'>
### Figure 4
<p style='font-size: 10px;'>The effect of increasing diversification rates (*x*-axis) on the emergence time of crown groups relative to the total group (*y*-axis). The data points used here are the values from <xref ref-type="fig" rid="RSTB20150287F3">figure&nbsp;3</xref>.</p>