...
thumb_url: 'http://europepmc.org/articles/PMC4549126/bin/12868_2015_191_Fig5_HTML.gif'
figure_no: 5
tags:
  - eupmc
  - figure
---
<img src='http://europepmc.org/articles/PMC4549126/bin/12868_2015_191_Fig5_HTML.jpg' style='max-height: 300px'>
### Figure 5
<p style='font-size: 10px;'>Localization of neuronal somata associated with the sixth post-oral and a midbody commissure in *Euperipatoides rowelli.* Retrograde fills. **a**, **b** Maximum projection confocal micrographs. Anterior is *left* in both images. *Syringes* indicate the corresponding fill sites. Note the similar arrangement of neuronal somata that are grouped near the basis of each commissure and do not show any anterior shift in position. *nc* nerve cord. *Scale bars* 100&nbsp;µm</p>